...
public class FastBRmain {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("Typical testors: "
				+ Integer.toString(brAlgorithm.getNumSoluciones()));
		System.out.println("Testors: " + Integer.toString(brAlgorithm.getNumSoluciones()));
		System.out.println("Candidates: " + Long.toString(brAlgorithm.contadorComprobaciones));
	}
